...
QT_MOC_LITERAL(1, 10, 15), // "signal_newparer"
QT_MOC_LITERAL(2, 26, 0) // ""

    },
    "newspaper\0signal_newparer\0"
};
...
void newspaper::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->signal_newparer(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (newspaper::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&newspaper::signal_newparer)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void newspaper::signal_newparer()
{
