...
public:
    ...
    void setupUi(QWidget *Friend)
    {
        ...
        Friend->resize(547, 504);
        gridLayout = new QGridLayout(Friend);
        gridLayout->setObjectName(QString::fromUtf8("gridLayout"));
        gridLayout->setVerticalSpacing(6);
        gridLayout->setContentsMargins(0, 0, 0, 0);
        friend_List = new QListWidget(Friend);
        friend_List->setObjectName(QString::fromUtf8("friend_List"));
        friend_List->setFrameShape(QFrame::NoFrame);

        gridLayout->addWidget(friend_List, 0, 0, 1, 1);
